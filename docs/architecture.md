...
| **C. Team run env.** | Projected RS/G, RA/G per team from A×B | Season-to-date runs, regressed (`pythag_60_sp`, Brier .24483) | **`pythag_C_sp` .24428** on the same 756 market games (−.00055, se .00086); .24603 vs .24657 on all 1,776 of 2026 and .24401 vs .24468 on 2025 — [market-benchmark-2026.md](market-benchmark-2026.md) | Built; **clears the gate on all three sets, inside 1 SE on each**; not wired | `src/sim/run_environment.py`; `strength.from_run_environment(rs, ra)` |
