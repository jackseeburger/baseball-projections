...
| **L2 → chain** | the per-game chain (stations C/E) still runs stock Marcel on both sides; the served engines reaching it is IN FLIGHT (BAS-90, `docs/chain-engines.md`) | same | — |
